"""
Django settings for hospitalizacionHogar project.
...
SECRET_KEY = 'django-insecure-f1=5n3dcn0sswx%t#92ojtthbww**j8*yj0bbrh^d3i6htalla'
...
ROOT_URLCONF = 'hospitalizacionHogar.urls'
...
WSGI_APPLICATION = 'hospitalizacionHogar.wsgi.application'
